...
module.exports.createProduct = async (req, res) => {
    ...
    try {
        ...
        console.log('Something went wrong in Controller: createProduct', error);
...
module.exports.getAllProducts = async (req, res) => {
    ...
    try {
        ...
        console.log('Something went wrong in Controller: getAllProducts', error);
        response.message = error.message;
    }
...
module.exports.getProductById = async (req, res) => {
    ...
    try {
        ...
        console.log('Something went wrong in Controller: getProductById', error);
        response.message = error.message;
    }
...
module.exports.updateProduct = async (req, res) => {
    ...
    try {
        ...
        console.log('Something went wrong in Controller: updateProduct', error);
        response.message = error.message;
    }
...
module.exports.deleteProduct = async (req, res) => {
    ...
    try {
        ...
        console.log('Something went wrong in Controller: deleteProduct', error);
        response.message = error.message;
    }
